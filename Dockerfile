...
RUN apt-get update && pip3 install toml --break-system-packages && git clone https://github.com/CVC4/CVC4.git && cd CVC4 && git reset --hard b826fc8ae95fc && ./contrib/get-antlr-3.4 && \
